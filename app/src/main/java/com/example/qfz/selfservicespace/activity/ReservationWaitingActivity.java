...
public class ReservationWaitingActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        confirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SendRequest(user.getUserID() + "\t" + reservation.reservationID);
            }
        });
    }
    ...
    private void SendRequest(final String requestMsg) {
        final Handler myhandler = new Handler() {
            public void handleMessage(Message msg) {
                ...
                {
                    //更新界面
                    Log.d("Cancel reservation", msg.getData().getString("msg"));
                    ...
                    if(connectionRes.state == 0) {
                        ...
                        {
                            Intent intent = new Intent(ReservationWaitingActivity.this, main_page.class);
                        ...
                        Toast.makeText(ReservationWaitingActivity.this, "Error", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        };
        ...
        new Thread(){
            public void run(){
                try {
                    ...
                    String msg = connection.connectServer(requestMsg, "/cancelReservation.json");
